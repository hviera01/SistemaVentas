...
class HistorialAbonosCompraDialog extends ConsumerWidget {
  ...
  Future<void> _editar(
    ...
    WidgetRef ref,
    AbonoCompraModel abono,
  ) async {
    await showDialog<bool>(
      useRootNavigator: false,
      context: context,
      builder: (context) =>
          EditarAbonoCompraDialog(compra: compra, abono: abono),
    );
  }
        ...
        PopupMenuItem(
          ...
          child: Row(
            children: [
              ...
              Text('Editar', style: GoogleFonts.poppins(fontSize: 12.5)),
            ],
          ),
        ),
        PopupMenuItem(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final anchoDialog = esMovil
        ? tamano.width - 24
        : (tamano.width - 48).clamp(0, 1100).toDouble();
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: Text(
                    'Historial de Abonos · ${compra.noFactura}',
            ...
            Expanded(
              child: abonosAsync.when(
                ...
                data: (abonos) {
                  ...
                  return esMovil
                      ? _tarjetas(context, ref, abonos)
                      : _tabla(context, ref, abonos);
                },
              ),
            ),
          ],
                ...
                return Padding(
                  ...
                  child: Row(
                    children: [
                      _celda(
                        3,
                        a.fecha != null ? formatoFecha.format(a.fecha!) : '-',
                      ),
                      _celda(
                        2,
                        formatearMoneda(a.montoAbonado),
                      ...
                      _celda(
                        2,
                        a.interes > 0 ? formatearMoneda(a.interes) : '-',
                      ),
                      _celda(
                        2,
                        formatearMoneda(a.saldoPendiente),
                        peso: FontWeight.w700,
                      ),
                      ...
                      SizedBox(
                        width: 40,
                        child: _menuAcciones(context, ref, a),
                      ),
                    ],
                  ),
                );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Saldo anterior: ${formatearMoneda(a.saldoAnterior)} → Saldo pendiente: ${formatearMoneda(a.saldoPendiente)}',
                style: GoogleFonts.poppins(
                  fontSize: 12,
              ...
              if (a.interes > 0) ...[
                const SizedBox(height: 4),
                Text(
                  'Interés aplicado: ${formatearMoneda(a.interes)}',
                  style: GoogleFonts.poppins(
                    fontSize: 12,
                    color: Colors.grey.shade700,
                  ),
