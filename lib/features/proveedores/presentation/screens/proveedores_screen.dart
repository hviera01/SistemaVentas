...
class _ProveedoresScreenState extends ConsumerState<ProveedoresScreen> {
  ...
  void _buscar() {
    ref
        .read(proveedoresBusquedaProvider.notifier)
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items: const [
            DropdownMenuItem(
              value: 'filtrados',
              child: Text('Proveedores filtrados'),
            ),
            ...
            child: CampoTecladoCompacto(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Buscar por RTN, razón social, correo o teléfono...',
            ...
            return Column(
              children: [
                ...
                InkWell(
                  onTap: () => setState(
                    () =>
                        _filaSeleccionada = seleccionado ? null : proveedor.id,
                  ),
                  child: Container(
                    color: seleccionado
                    ...
                    child: Row(
                      children: [
                        _celda(
                          2,
                          proveedor.rtn.isEmpty ? '-' : proveedor.rtn,
                          peso: FontWeight.w600,
                        ),
                        _celda(
                          3,
                          proveedor.razonSocial.isEmpty
                              ? '-'
                        ...
                        if (mostrarCorreo)
                          _celda(
                            3,
                            proveedor.correo.isEmpty ? '-' : proveedor.correo,
                            gris: true,
                          ),
                        _celda(
                          2,
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 8,
                  children: [
                    if (proveedor.rtn.isNotEmpty)
                      _chipInfo('RTN', proveedor.rtn),
                    if (proveedor.correo.isNotEmpty)
                      _chipInfo('Correo', proveedor.correo),
                    if (proveedor.telefono.isNotEmpty)
                      _chipInfo('Teléfono', proveedor.telefono),
